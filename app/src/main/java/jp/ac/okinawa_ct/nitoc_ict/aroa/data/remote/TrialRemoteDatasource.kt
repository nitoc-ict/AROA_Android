...
interface TrialRemoteDatasource {
     ...
     */
    suspend fun getTrialById(id: String): Result<Trial?>
     ...
     */
    suspend fun getTriedTrialByUserId(userId: String): Result<List<Trial>>
     ...
     */
    suspend fun getTrialNear(location: LatLng, radius: Double): Result<List<Trial>>
